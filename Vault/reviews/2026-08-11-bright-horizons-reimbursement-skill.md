...
- The change remains in the owning iCode vertical specialization, consistent
  ...
  `source/verticals/icode/icode-invoice-operations/SKILL.md:8-19`.
- The ambiguous report prompt is now an explicit reimbursement-workbook intent,
  ...
  `source/verticals/icode/icode-invoice-operations/SKILL.md:28-46`.
- Missing evidence, customer billing settings, or template state fails closed
  at `source/verticals/icode/icode-invoice-operations/SKILL.md:50-65` and
  `source/verticals/icode/icode-invoice-operations/SKILL.md:90-99`, satisfying
...
- Customer billing identity and rates remain outside canonical package content.
  ...
  `source/verticals/icode/icode-invoice-operations/references/bright-horizons-workbook.md:28-44`,
...
- The packaged template is customer-neutral and authoritative for workbook
  ...
  at `source/verticals/icode/icode-invoice-operations/scripts/build_bh_invoice.mjs:17-39`.
  Required normalized inputs, date bounds, child counts, and rates are validated
  at `source/verticals/icode/icode-invoice-operations/scripts/build_bh_invoice.mjs:41-89`.
- The builder consumes the distributed template for metadata, headers, formats,
  widths, totals, and output summary at
  `source/verticals/icode/icode-invoice-operations/scripts/build_bh_invoice.mjs:126-258`.
...
- `node scripts/check-package.mjs`: passed package structure, product, skill,
  and credential scan.
- `python3 .../skill-creator/scripts/quick_validate.py source/verticals/icode/icode-invoice-operations`:
  passed.
