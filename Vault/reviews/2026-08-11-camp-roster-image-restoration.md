...
- `source/verticals/icode/icode-class-operations/`;
...
- The output rule belongs in the iCode vertical specialization under
...
- Private roster retrieval remains on the named BOS route and server-derived
  scope in `source/verticals/icode/icode-class-operations/SKILL.md:14-43`,
...
- The client only renders verified business state. The renderer accepts five
  ...
  `source/verticals/icode/icode-class-operations/scripts/render_week_calendar.py:31-61`;
...
- The skill requires one `Student — Camp` line per attendance day and keeps
  ...
  `source/verticals/icode/icode-class-operations/SKILL.md:75-100`. Missing or
...
- `python3 .../quick_validate.py` passed for the personal
  `camp-capacity-planning` skill and canonical `icode-class-operations` skill.
