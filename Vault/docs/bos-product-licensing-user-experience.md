...
| Education Center | Active package, version `0.4.46` | Active named resource `/mcp/apps/leaddirector/education-center` with a real tool and provider allowlist | Current server-backed product and the primary no-fee access baseline |
