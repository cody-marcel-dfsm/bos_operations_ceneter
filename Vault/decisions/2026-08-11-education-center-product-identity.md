...
OAuth 2.1. Claude uses an account or organization Web connector with a
persistent **Connect** control; Copilot and Gemini declare it directly, and Codex references the registered Education Operation
