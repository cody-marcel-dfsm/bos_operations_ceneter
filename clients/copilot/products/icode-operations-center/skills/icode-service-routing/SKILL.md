...
description: Route iCode and Cherry Creek requests to the appropriate tenant-scoped BOS capability according to the requested operation and Cody's provider preferences. Use whenever an iCode workflow needs Gmail, Calendar, Drive, Calimatic, Lead Director, calls, SMS, reviews, outreach, student data, camp data, enrollment data, or another connected business service.
---
